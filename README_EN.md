...
| Requirement | Notes |
| -------- | -------- |
| [Nerd Font](https://www.nerdfonts.com/) - we use Nerd Font for the file picker. | You'll know it's missing when your icons look like "□" |
...
- Use the v4.4.1 of the engine (currently Latest)
